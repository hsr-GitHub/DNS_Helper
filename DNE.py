...
def sort(domain_name_list_filename):
	shutil.copy(domain_name_list_filename,
				'{}.tmp'.format(domain_name_list_filename))
	domain_name_list_file = open(
		'{}.tmp'.format(domain_name_list_filename), 'r')
	domain_name_list_file_sorted = open(domain_name_list_filename, 'w')
	domain_name_list_file_sorting = list(domain_name_list_file)
	domain_name_list_file_sorting.sort()
	for line in domain_name_list_file_sorting:
		domain_name_list_file_sorted.write(line)
	domain_name_list_file.close()
	domain_name_list_file_sorted.close()
	os.remove('{}.tmp'.format(domain_name_list_filename))
